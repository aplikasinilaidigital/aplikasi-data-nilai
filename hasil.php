        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h4 class="h1 mb-0 text-gray-800" style="font-family: Arial, sans-serif; font-size: 40px; font-weight: bold; color: #333;">LAPORAN NILAI SISWA</h4>
                    <p>SMK PGRI 1 CIMAHI</p>
                    <form method="get" action="hasil.php" class="mb-3">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Cari berdasarkan NISN atau Nama" name="keyword" value="<?php echo htmlspecialchars($keyword); ?>">
