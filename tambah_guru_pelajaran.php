...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    var_dump($nip, $nama, $mata_pelajaran);

    
    $sql = "INSERT INTO tbl_guru_pelajaran(nip, nama, mata_pelajaran) VALUES (?, ?, ?)";
    ...
    $stmt->bind_param("sss", $nip, $nama, $mata_pelajaran);

    if ($stmt->execute()) {
        echo "<script>alert('Data guru berhasil ditambahkan.'); window.location.href = 'guru_pelajaran.php';</script>";
    } else {
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p>Silakan isi formulir berikut untuk menambahkan guru baru.</p>
